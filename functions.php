 ...
 */
function our_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'our_content_width', 640 );
}
add_action( 'after_setup_theme', 'our_content_width', 0 );
...
function our_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'our' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'our' ),
...
function our_scripts() {
	...
	wp_enqueue_script( 'our-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'our-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( 'our-smithweb', get_template_directory_uri() . '/js/smithweb.js', array(), '20151215', true );
